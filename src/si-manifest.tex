...
\midrule
\midrule 
\multirow{13}{*}{Si} & Hero/Parent & 正常 & - & N/A & 经验，细节，稳健 & 参照经验，细节敏感，追求守序\tabularnewline
\cmidrule{2-7}
 & \multirow{2}{*}{Child} & 游戏 & \multirow{2}{*}{\begin{cellvarwidth}[t]
\centering
INTP\\
INFP
\end{cellvarwidth}} & N/A & \multirow{2}{*}{还是旧的好} & 恋旧收藏，沉溺舒适，重复安稳\tabularnewline
\cmidrule{3-3}\cmidrule{5-5}\cmidrule{7-7}
 &  & 幼稚 &  & 压力 &  & 抗拒改变，退行童年，逃避现实\tabularnewline
\cmidrule{2-7}
...
ENTP\\
ENFP
\end{cellvarwidth}} & N/A & “我想拥有根基” & \begin{cellvarwidth}[t]
\centering
仪式感，片刻怀旧\\
收藏童年玩具，过分执着某个节日
...
压抑\\
(Suppression)
\end{cellvarwidth} &  & 防御性屏蔽 & “身体是Ne的累赘” & \begin{cellvarwidth}[t]
\centering
肉体忽视，反常规\\
昼夜颠倒，生活区像垃圾场，\\
拒绝体检
...
主导功能\\
受到挑战
\end{cellvarwidth} & \multirow{2}{*}{“别拿过去压我”} & \begin{cellvarwidth}[t]
\centering
轻视经验：\\
极度讨厌“老规矩”或繁琐的流程，\\
故意打破常规
...
ISTP\\
ISFP
\end{cellvarwidth}} & 防御机制 & \multirow{2}{*}{批判经验: 你真弱} & 翻旧帐，指责不可靠不长记性/否定毅力\tabularnewline
\cmidrule{3-3}\cmidrule{5-5}\cmidrule{7-7}
 &  & 对内自毁 &  & 防御机制 &  & 创伤反刍，不断回忆过去的痛苦\tabularnewline
\cmidrule{2-7}
