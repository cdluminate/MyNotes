...
\part{Depth Psychology Cheat Sheet}
...
\begin{table}[h!]
\caption[基于 DSM-5 标准的人格障碍分类汇总]{基于 DSM-5 标准的人格障碍分类汇总。注：人格障碍是指一种持久的、死板的思维和行为模式，显著偏离个体所属文化背景的预期，导致严重的痛苦或功能受损。}
    \centering
...
% Beebe's book excerpts.
\part{Energies and Patterns in Psychological Type~\cite{beebe} (Excerpts)}
\include{src/beebe-energies-and-patterns/main.tex}
