...
\begin{table}[h!]
    ...
    \textcolor{gray}{\small Source: Page 4, Section ``The Eight Function-Attitudes Unpacked'' from ``Energies and Patterns in Psychological Type''.}}
    \begin{center}
