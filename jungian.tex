...
\begin{table}[h!]
    \caption[八功能关键词 \verified]{八功能关键词 | Keywords for the Essence of the Eight Function-attitudes. The reader may recall that each of these words a verbal noun or process word. Each describes a procedure that a mind can follow over time, a procedure aimed at perceiving or judging reality as accurately as possible, which is the aim of any consciousness.\\
    {\small Source: Page 4, Section ``The Eight Function-Attitudes Unpacked'' from ``Energies and Patterns in Psychological Type''.}}
    \begin{center}
        \begin{tabular}{ccc}
            \toprule
            Function-attitude & Full Name & Keyword in Everyday Language \tabularnewline
            \midrule
            Fi & Introverted Feeling & Appraising \tabularnewline
            Ti & Introverted Thinking & Defining \tabularnewline
            Ni & Introverted Intuition & Knowing \tabularnewline
            Si & Introverted Sensing & Verifying \tabularnewline 
            Fe & Extraverted Feeling & Affirming \tabularnewline
            Te & Extraverted Thinking & Planning \tabularnewline
            Ne & Extraverted Intuition & Envisioning \tabularnewline  
            Se & Extraverted Sensing & Experiencing \tabularnewline
            \bottomrule
        \end{tabular}
    \end{center}
\end{table}
