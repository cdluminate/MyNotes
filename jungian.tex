...
\begin{table}[h!]
    ...
    \begin{center}
        \begin{tabular}{ccc}
            \toprule
            \textbf{Function-attitude} & \textbf{Full Name} & \textbf{Semantic Field Triangle} (persona, ego, Self)\tabularnewline
            \midrule

            Se & Extraverted Sensing & Engaging, Experiencing, Enjoying \tabularnewline
            Si & Introverted Sensing & Implementing, Verifying, Accounting \tabularnewline 

            Ne & Extraverted Intuition & Entertaining, Envisioning, Enabling \tabularnewline  
            Ni & Introverted Intuition & Imagining, Knowing, Divining \tabularnewline

            Te & Extraverted Thinking & Regulating, Planning, Enforcing \tabularnewline
            Ti & Introverted Thinking & Naming, Defining, Understanding \tabularnewline

            Fe & Extraverted Feeling & Validating, Affirming, Relating \tabularnewline
