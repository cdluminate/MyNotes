...
\begin{tabular}{|l|l|l|}
\hline
\textbf{类别} & \textbf{类型} & \textbf{核心特征} \\ \hline
\multirow{3}{*}{A类 (古怪型)} & 偏执型 (PPD) & 普遍怀疑与不信任他人 \\ \cline{2-3}
 & 分裂样 (Schizoid) & 社交退缩，情感冷漠 \\ \cline{2-3}
 & 分裂型 (Schizotypal) & 行为怪异，奇特幻想 \\ \hline
\multirow{4}{*}{B类 (戏剧型)} & 边缘型 (BPD) & 情绪极其不稳，害怕被抛弃 \\ \cline{2-3}
 & 自恋型 (NPD) & 夸大自我，缺乏共情 \\ \cline{2-3}
 & 反社会型 (ASPD) & 漠视法律与他人权利 \\ \cline{2-3}
 & 表演型 (HPD) & 过度寻求关注，情感夸张 \\ \hline
\multirow{3}{*}{C类 (焦虑型)} & 回避型 (AvPD) & 极度自卑，社交抑制 \\ \cline{2-3}
 & 依赖型 (DPD) & 过度顺从，害怕独处 \\ \cline{2-3}
 & 强迫型 (OCPD) & 追求完美，僵化固执 \\ \hline
\end{tabular}
\end{table}
