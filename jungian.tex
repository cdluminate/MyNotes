...
\include{src/beebe-function-attitudes.tex}
...
\include{src/ne-manifest.tex}

\include{src/ti-manifest.tex}

\include{src/fe-manifest.tex}

\include{src/si-manifest.tex}
...
\begin{table}[h!]
    \caption{16种人格类型：人口占比与发展水平分布形态}
    \centering
    \renewcommand{\arraystretch}{1.2} % 增加行高，提升阅读体验
    %\footnotesize % 字体调整为小号，防止爆行
    \begin{tabular}{c c c c L{4.2cm} L{4.2cm}}
        \toprule
        \textbf{维度} & \textbf{类型} & \textbf{占比} & \textbf{分布形态} & \textbf{低阶表现 (下限)} & \textbf{高阶表现 (上限)} \\
        \midrule

        % NT系
        \multirow{4}{*}{\shortstack{\textbf{NT系} \\ \scriptsize ($\approx 10\%$)}}
        & INTJ & 2.1\% & U型 (极化) & 愤世嫉俗、Ni-Fi死循环、傲慢且无能 & 战略宗师、系统构建者、神性与人性整合 \\
        & ENTP & 3.2\% & 高方差正态 & 杠精、缺乏定性、混乱邪恶 & 创新发明家、打破僵局的变革者 \\
        & INTP & 3.3\% & 双峰分布 & 虚无主义、生活低能、思维瘫痪 & 逻辑构建者、超越时代的真理探索者 \\
        & ENTJ & 1.8\% & 右偏 (高下限) & 冷酷暴君、为目的不择手段 & 帝国统帅、高效且目光长远的建设者 \\
        \midrule

        % NF系
        \multirow{4}{*}{\shortstack{\textbf{NF系} \\ \scriptsize ($\approx 16\%$)}}
        & INFJ & 1.5\% & U型 (极化) & 极度敏感、操控型圣母、脱离现实 & 精神领袖、洞察世俗的智者 \\
        & INFP & 4.4\% & 左偏 (低均值) & 抑郁倾向、受害者心态、行动瘫痪 & 治愈者、深刻的哲学家、纯粹理想载体 \\
        & ENFJ & 2.5\% & 右偏 (高下限) & 伪善、控制欲强、强加价值观 & 真正的导师、凝聚人心的领袖 \\
        & ENFP & 8.1\% & 正态 (扁平) & 三分钟热度、情绪过山车 & 启发他人的缪斯、拥有无限可能性的探索者 \\
        \midrule

        % SJ系
        \multirow{4}{*}{\shortstack{\textbf{SJ系} \\ \scriptsize ($\approx 46\%$)}}
        & ISTJ & 11.6\% & 右偏 (高下限) & 刻板固执、机械执行的工具人 & 社会基石、极其可靠的执行者 \\
        & ISFJ & 13.8\% & 右偏 (高下限) & 过度牺牲、讨好型人格、缺乏主见 & 温柔坚定的守护者、润物细无声 \\
        & ESTJ & 8.7\% & 右偏 (高下限) & 控制狂、缺乏共情的官僚 & 高效管理者、秩序维护者、公正无私 \\
        & ESFJ & 12.3\% & 右偏 (高下限) & 八卦、随波逐流、依赖群体评价 & 社群核心、极具号召力的关怀者 \\
        \midrule

        % SP系
        \multirow{4}{*}{\shortstack{\textbf{SP系} \\ \scriptsize ($\approx 27\%$)}}
        & ISTP & 5.4\% & 正态分布 & 冷漠孤僻、寻求刺激却无目的 & 精通技艺的大师、极度冷静的破局者 \\
        & ISFP & 8.8\% & 左偏 (低均值) & 自我沉溺、情绪化、无病呻吟 & 灵魂艺术家、极致的审美与道德感 \\
        & ESTP & 4.3\% & M型 (双极) & 鲁莽赌徒、享乐主义、反社会倾向 & 极具魅力的领袖、高风险问题解决者 \\
        & ESFP & 8.5\% & 正态分布 & 肤浅、冲动、无法忍受寂寞 & 点燃他人的生命之火、活在当下的智者 \\
...
\begin{table}[h!]
    \caption{基于 DSM-5 标准的人格障碍分类汇总。注：人格障碍是指一种持久的、死板的思维和行为模式，显著偏离个体所属文化背景的预期，导致严重的痛苦或功能受损。}
    \centering
    \renewcommand{\arraystretch}{1.6}
    \footnotesize
    \begin{tabular}{c c L{3.5cm} L{8cm}}
        \toprule
        \textbf{群组} & \textbf{障碍类型} & \textbf{核心病理特征} & \textbf{典型表现与思维模式} \\
        \midrule

        % Cluster A
        \multirow{3}{*}{\shortstack{\textbf{A类} \\ \scriptsize (奇特/古怪)}}
        & 偏执型 (Paranoid) & 普遍的不信任与猜疑 & 无端怀疑他人动机，将善意曲解为恶意，极易怀恨在心。 \\
        & 分裂样 (Schizoid) & 情感剥离与社交冷漠 & 根本不需要人际关系，对赞扬或批评无动于衷，类似“情感机器人”。 \\
        & 分裂型 (Schizotypal) & 认知扭曲与行为怪然 & 拥有魔幻思维（如第六感），言语古怪，社交极度焦虑。 \\
        \midrule

        % Cluster B
        \multirow{4}{*}{\shortstack{\textbf{B类} \\ \scriptsize (戏剧/情绪)}}
        & 反社会型 (Antisocial) & 漠视侵犯他人权利 & 缺乏良知与悔意，冲动欺诈，利用他人，无视法律与规则。 \\
        & 边缘型 (Borderline) & 人际与自我极度不稳定 & 情绪过山车，极度恐惧被抛弃，在“理想化”与“贬低”间剧烈切换。 \\
        & 表演型 (Histrionic) & 过度情绪化与求关注 & 肤浅夸张，必须成为焦点，利用外表诱惑他人，极易受暗示。 \\
        & 自恋型 (Narcissistic) & 浮夸自大与缺乏共情 & 极度需要赞美，认为自己享有特权，为了目的剥削他人。 \\
        \midrule

        % Cluster C
        \multirow{3}{*}{\shortstack{\textbf{C类} \\ \scriptsize (焦虑/恐惧)}}
        & 回避型 (Avoidant) & 社交抑制与自卑感 & 渴望社交但因惧怕拒绝而退缩，认为自己无能、无吸引力。 \\
        & 依赖型 (Dependent) & 过度的被照顾需求 & 顺从黏人，无法独立决策，害怕分离，无底线容忍虐待。 \\
        & 强迫型 (OCPD) & 对秩序与控制的沉迷 & *不同于OCD。* 完美主义致使任务无法完成，僵化固执，无法授权。 \\
...
\begin{tabular}{|l|l|l|}
\hline
\textbf{依恋类型} & \textbf{核心态度} & \textbf{典型行为表现} \\ \hline
安全型 (Secure) & 低焦虑，低回避 & 信任伴侣，能平衡独立与亲密 \\ \hline
焦虑型 (Anxious) & 高焦虑，低回避 & 渴望亲密，过度担心被抛弃 \\ \hline
疏离回避型 (Dismissive) & 低焦虑，高回避 & 压抑需求，极度强调自主独立 \\ \hline
恐惧回避型 (Fearful) & 高焦虑，高回避 & 渴望亲密但因恐惧而推开他人 \\ \hline
\end{tabular}
\end{table}
